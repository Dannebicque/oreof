...
## [1.53.0](https://github.com/OReOF-URCA/oreof/compare/v1.52.0...v1.53.0) (2026-05-17)


### Features

* add co-responsable field and update formation handling in forms ([c2f646c](https://github.com/OReOF-URCA/oreof/commit/c2f646c5fa3fcd3d14172750d4529218d60e9a3d))
* add date of function start to change request and enhance migration command for mutualisation ([58d9949](https://github.com/OReOF-URCA/oreof/commit/58d9949abf957f75e05b38bf627fe51cf056aff5))
* add delete functionality for DPE requests with admin access ([6c9974d](https://github.com/OReOF-URCA/oreof/commit/6c9974dfd6182ec7e67fe9ddbdd525152a33adc7))
* add force next step functionality for parcours and formation with history option ([bbd6485](https://github.com/OReOF-URCA/oreof/commit/bbd64858262bf13a69cd98b98223c79af9f47a03))
* add handling for new parcours in campaign with conditional export options ([2ef0c50](https://github.com/OReOF-URCA/oreof/commit/2ef0c502b90099edb57e7b3cc2ad66b72cf704c6))
* add handling for new parcours in campaign with conditional export options ([060b764](https://github.com/OReOF-URCA/oreof/commit/060b7647fec28718da5c38e40d61ca6664fc9ee8))
* add header cell writing method and update export logic for enhanced Excel output ([2334de5](https://github.com/OReOF-URCA/oreof/commit/2334de542fdbd0318d064e947ccdfabfbf821639))
* add isNonOuvert method to DpeParcours and Formation classes for better state handling ([f60a89b](https://github.com/OReOF-URCA/oreof/commit/f60a89b8f8ff043bb42f5087e06af7e57b74ace1))
* add log viewer functionality with log file listing and parsing ([593f234](https://github.com/OReOF-URCA/oreof/commit/593f234f62f96468eed87ed189e54a551530141e))
* add pilotage feature for composante with statistics and visual representation ([bb56088](https://github.com/OReOF-URCA/oreof/commit/bb5608892d501575f08d96b982763239ebdd261d))
* add recompute functionality for MCCC validity and update form handling ([d330b0c](https://github.com/OReOF-URCA/oreof/commit/d330b0c92e15fdb876b0339d35306a81b45546eb))
* add required indicator to note label in validation template ([f282ad0](https://github.com/OReOF-URCA/oreof/commit/f282ad087174ad2005e42fe3c36c4da6170ffce4))
* add required indicator to note label in validation template ([f9f388b](https://github.com/OReOF-URCA/oreof/commit/f9f388bd62dfd0d90022323ab1272a5beaee8263))
* add required indicator to note label in validation template ([3e732f7](https://github.com/OReOF-URCA/oreof/commit/3e732f767b655d9d4c71e918a07c0c3502ec06e2))
* add required indicator to note label in validation template ([07daa6a](https://github.com/OReOF-URCA/oreof/commit/07daa6ae54aab47c13e73f852274631555ec295a))
* add support for displaying explanatory notes in formation history ([8aff6bd](https://github.com/OReOF-URCA/oreof/commit/8aff6bdc8c74fb47e7cb1377dec918ca980e081d))
* add upload note option and update French translations for parcours validation ([1258363](https://github.com/OReOF-URCA/oreof/commit/1258363564852b32c3102937c746ae59aee5ac9a))
* add validation step for tacite reconduction with metadata for recipients ([018d3bb](https://github.com/OReOF-URCA/oreof/commit/018d3bbd1374b88cbad89c3b40e084fc7c373566))
* add volume horaire export functionality and related command ([bd45538](https://github.com/OReOF-URCA/oreof/commit/bd45538c82f39577165921d53fee0417718d9964))
* add volume horaire export functionality and related command ([dd1cbdd](https://github.com/OReOF-URCA/oreof/commit/dd1cbddbbf4597077b4277b8ffc010027920bccd))
* conditionally add export version button for non-new parcours in synthese button provider ([47927c9](https://github.com/OReOF-URCA/oreof/commit/47927c934f17c6cdefe24a88a59dc047e694dd8b))
* create new demande if none exists during modification process and update template rendering ([0249264](https://github.com/OReOF-URCA/oreof/commit/0249264c62d7c4db6477a5c2f3a67e916ba4abef))
* enhance access control logic in RessourceVoter for parcours validation ([808dd10](https://github.com/OReOF-URCA/oreof/commit/808dd106c60ec1e26a0f09932197373b2f91a7e5))
* enhance administration routes and improve comment handling in controllers ([d5b9795](https://github.com/OReOF-URCA/oreof/commit/d5b9795dd8175bcf9b6edac1f40b94fca003a57e))
* enhance file upload handling with original filename support and secure upload service integration ([fa1f217](https://github.com/OReOF-URCA/oreof/commit/fa1f217cc80ba47addb403bfce8215fc7161caa9))
* enhance filtreHeures method to handle string input and null values ([cd88a70](https://github.com/OReOF-URCA/oreof/commit/cd88a704c0f3d4f8cea9d34c1b3cb15f41b96c8b))
* enhance filtreHeures method to handle string input and null values ([7d6c01f](https://github.com/OReOF-URCA/oreof/commit/7d6c01f3a85adea0b72967da84e7622fb1bf145b))
* enhance table rendering logic to support nested elements and improve display of child competencies ([30c435a](https://github.com/OReOF-URCA/oreof/commit/30c435aeeb8388f4b95d049c7bcd7216eeced781))
* enhance validation DPE management with improved statistics and dynamic content loading ([1752365](https://github.com/OReOF-URCA/oreof/commit/175236590d3a6a3ea31920365d772720834f450d))
* enhance validation DPE management with improved statistics and dynamic content loading ([8344da8](https://github.com/OReOF-URCA/oreof/commit/8344da8225119b867ce2468f8898e7656eec5262))
* enhance validation DPE management with improved statistics and dynamic content loading ([f8e40e8](https://github.com/OReOF-URCA/oreof/commit/f8e40e83f2d1666abc2e59157421ab46273f204d))
* enhance validation DPE management with improved statistics and dynamic content loading ([93eb7bb](https://github.com/OReOF-URCA/oreof/commit/93eb7bb92deab35b364f9f54f7a18c6ae8a9074f))
* enhance validation DPE management with improved statistics and dynamic content loading ([a6952e9](https://github.com/OReOF-URCA/oreof/commit/a6952e9e40226067112b9b3a93f7b73a3271789b))
* export MCCC M2E ([9ddf323](https://github.com/OReOF-URCA/oreof/commit/9ddf32392e0b0beeae18e64bb33d309d28d21948))
* export MCCC M2E ([fbd8d5c](https://github.com/OReOF-URCA/oreof/commit/fbd8d5cfaa0a42f072224fbec863ad231787eb4a))
* export MCCC M2E ([44ab668](https://github.com/OReOF-URCA/oreof/commit/44ab66869ad5b4f320ddebd3da028ced0caddc85))
* export MCCC M2E ([9f0df85](https://github.com/OReOF-URCA/oreof/commit/9f0df85d877f587c8f5c763a2509b90c9444c213))
* export MCCC M2E ([fa7489e](https://github.com/OReOF-URCA/oreof/commit/fa7489e8bf1c8d0b745e61d2af6e1aae8c0c6356))
* export MCCC M2E ([5ed46e6](https://github.com/OReOF-URCA/oreof/commit/5ed46e61908213b2e3a78e08519060b440b99096))
* export MCCC M2E ([bead11f](https://github.com/OReOF-URCA/oreof/commit/bead11f396d6e1d8cbfef32156ca594ed1fe1cac))
* implement mutualisation notification system with acknowledgment handling ([4474ff8](https://github.com/OReOF-URCA/oreof/commit/4474ff8fbe86688069242b0cf17b6bd52b2c4307))
* integrate TypeDiplomeResolver for improved structure calculation in competence export ([0186f2c](https://github.com/OReOF-URCA/oreof/commit/0186f2c7378d296ce11a9041b2e92adb28c6210f))
* refactor button rendering logic to conditionally include version button based on DPE state ([c7e9dab](https://github.com/OReOF-URCA/oreof/commit/c7e9dab7750669dac06942859d037771ba226beb))
* refactor button rendering logic to conditionally include version button based on DPE state ([7397d3b](https://github.com/OReOF-URCA/oreof/commit/7397d3b7856dc73be020ae13a7b5d3c22adbabd4))
* refactor button rendering logic to conditionally include version button based on DPE state ([de42427](https://github.com/OReOF-URCA/oreof/commit/de424279bd4d2072713d0eb1176c3e2b6d1cba4a))
* refactor export logic to enhance structure and improve BCC export functionality ([63ad815](https://github.com/OReOF-URCA/oreof/commit/63ad8156bcf348e746a40a703e09f2beba5dbd66))
* reset responsible for duplicated fiche matière in parcours duplication process ([0a69aa9](https://github.com/OReOF-URCA/oreof/commit/0a69aa9564ac4c70a978aac23c60c51a63566c53))
* simplify button rendering logic by removing version check for parcours ([b918819](https://github.com/OReOF-URCA/oreof/commit/b918819364b18f8ccc926c4c7c3b7dd351f4f76d))
* update DiffObject calculations to use 'ects' field for resource and SAE types ([f75bf29](https://github.com/OReOF-URCA/oreof/commit/f75bf29b70b0938d4f46a3858f7a864ca7399011))
* update parcours templates to use correct annee.ordre and improve structure inclusion ([12be330](https://github.com/OReOF-URCA/oreof/commit/12be3304604c8a67e655123761c9811a1c30c314))
* update parcours templates to use correct annee.ordre and improve structure inclusion ([8cd044c](https://github.com/OReOF-URCA/oreof/commit/8cd044cd12ce51f05390a98c1a7446840826e494))
* update translations and modify label rendering in DPE template ([8bc8a1c](https://github.com/OReOF-URCA/oreof/commit/8bc8a1c5b0cf57ceacb84436fa23f83539e42ae2))


### Bug Fixes

* add fallback mechanism for Excel generation in LicenceMcccVersion ([4027b64](https://github.com/OReOF-URCA/oreof/commit/4027b6454a003a543e4ed84caed92c4a8307b1c9))
* add fallback mechanism for Excel generation in LicenceMcccVersion ([efbbfe9](https://github.com/OReOF-URCA/oreof/commit/efbbfe9adebeb1aa236202010555be06e92740f6))
* add fiches export case to enhance export functionality ([dfd7112](https://github.com/OReOF-URCA/oreof/commit/dfd71126ae04e77a561207360b1906a7347c5d97))
* bugs dans les logs ([9481724](https://github.com/OReOF-URCA/oreof/commit/94817246d49733083280017d407d8772abe66af5))
* bugs dans les logs ([dde7676](https://github.com/OReOF-URCA/oreof/commit/dde76762fcf5b3fb811d8122a7b8d6378556a86d))
* comparaison heures stages ([0ba488d](https://github.com/OReOF-URCA/oreof/commit/0ba488df8411d0b390262c819d93fcbca6fcb25c))
* comparaison maquette - ue ([97896ed](https://github.com/OReOF-URCA/oreof/commit/97896ed39424fd264e9c8366107b55dfe53eb897))
* email CFVU, typo sur variables ([6e811a5](https://github.com/OReOF-URCA/oreof/commit/6e811a53f01e025163e71a552a0ff6ee3eadc973))
* email CFVU, typo sur variables ([3f913e7](https://github.com/OReOF-URCA/oreof/commit/3f913e73156ef362a36a9b249f7a65b878a8aa4c))
* enhance ECTS handling and improve MCCCs comparison logic in structure management ([9215c62](https://github.com/OReOF-URCA/oreof/commit/9215c6246be09f7ca5b3108abc607db21fe9765b))
* ensure user is not null before saving and dispatching event in ParcoursSaveController ([2947751](https://github.com/OReOF-URCA/oreof/commit/29477519b62c5a5de489a1870966b651b1217060))
* handle potential null values in localisation mentions ([47ca136](https://github.com/OReOF-URCA/oreof/commit/47ca136783c5b3cc426811f03e38551657c8ef67))
* handle potential null values in localisation mentions ([917cfe3](https://github.com/OReOF-URCA/oreof/commit/917cfe31635db052875edc7dbf306b12bc959a16))
* handle potential null values in localisation mentions ([861b32a](https://github.com/OReOF-URCA/oreof/commit/861b32aa6b90fb4203cf61c50a7320de7b5a3931))
* handle potential null values in localisation mentions ([28b8737](https://github.com/OReOF-URCA/oreof/commit/28b873784199b87fa7fcb496b0b339ec397c56da))
* indentation ([f9eb83b](https://github.com/OReOF-URCA/oreof/commit/f9eb83bbdf61148ed8e5646f54fa8632c4927c30))
* Services Versioning - comparaisons ([5a7c4b2](https://github.com/OReOF-URCA/oreof/commit/5a7c4b252e54c197b828b92c5592b0089d09eaa5))
* set modification level for demande and update state reconduction logic ([7d6d6ad](https://github.com/OReOF-URCA/oreof/commit/7d6d6ade3c74a8e4041a1afdbf9734b0a8ff2d15))
* set modification level for demande and update state reconduction logic ([d39c6a7](https://github.com/OReOF-URCA/oreof/commit/d39c6a73d0c379bcf45466d590b11f45112d6d88))
* set modification level for demande and update state reconduction logic ([81642f0](https://github.com/OReOF-URCA/oreof/commit/81642f0f6162117bfdfbee261a03cca81543365a))
* update cell references for date columns in Excel export ([17dceae](https://github.com/OReOF-URCA/oreof/commit/17dceaefaed67231da0cff5f649cef08587b321b))
* update email contact in breadcrumb links to reflect new address ([16297ec](https://github.com/OReOF-URCA/oreof/commit/16297ec7c9f444221218097d824ba38b15fb2ac6))
* update parcours display in _liste.html.twig template ([78ebb4e](https://github.com/OReOF-URCA/oreof/commit/78ebb4e341ac0d4a0afe2aee3ac47fb82cf17462))
* update parcours display in _liste.html.twig template ([575228f](https://github.com/OReOF-URCA/oreof/commit/575228fb466a6499b13fe55cb82df4425425223d))
* update parcours display in _liste.html.twig template ([f53f26b](https://github.com/OReOF-URCA/oreof/commit/f53f26baa4470a5d3ebe533bbb05af8dfcfefd58))
* update parcours display in _liste.html.twig template ([6fbf49e](https://github.com/OReOF-URCA/oreof/commit/6fbf49ec2c22cd8c7e9ca757c9f55b907d5273fe))
* versioning view ([59a7d28](https://github.com/OReOF-URCA/oreof/commit/59a7d282783bda38a5475c0bb03f193379963e69))
