...
final class ValiderReserveCommentaireDateHandler extends AbstractDpeParcoursHandler implements TransitionHandlerInterface
{
    public function supports(string $code): bool
    {
        return $code === 'valider_reserve_date';
    }
